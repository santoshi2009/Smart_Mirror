...
So This is my first official hardware project. i am so excited for this .i wanted to build something which i can help me learn hardware and engineering with linux environment as well. So i was searching for the project that teaches me both .So i decided to work on this Smart mirror based on raspberry pi .This smart mirror will help me start day more organized .i had earlier decided to do the project but becasue of the lack of the sufficient material i was unable to make ..Thanks to hackclub for this Amazing concept to help the geeks to learn by providing guidance and grant. i am excited to work on this project so It would be great learning and fun working on this project.
